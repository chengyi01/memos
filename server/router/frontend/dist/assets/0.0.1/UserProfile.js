import { o as observer, u as useTranslate, Q as useParams, b as useLoading, V as userStore, n, f as extractUserIdFromName, m as memoFilterStore, j as jsxRuntimeExports, B as Button, W as UserAvatar, P as PagedMemoList, v as viewStore, S as State, M as MemoView, X as copy } from "./index.js";
...
const UserProfile = observer(() => {
  ...
  reactExports.useEffect(() => {
    ...
    userStore.getOrFetchUserByUsername(username).then((user2) => {
      ...
      console.error(error);
      n.error(t("message.user-not-found"));
    });
  }, [params.username]);
