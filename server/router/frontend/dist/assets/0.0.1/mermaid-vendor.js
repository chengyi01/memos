const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/0.0.1/dagre-JOIXM2OF.js","assets/0.0.1/graph.js","assets/0.0.1/utils-vendor.js","assets/0.0.1/layout.js","assets/0.0.1/c4Diagram-6F6E4RAY.js","assets/0.0.1/chunk-67H74DCK.js","assets/0.0.1/flowDiagram-KYDEHFYC.js","assets/0.0.1/chunk-E2GYISFI.js","assets/0.0.1/chunk-BFAMUDN2.js","assets/0.0.1/chunk-SKB7J2MH.js","assets/0.0.1/erDiagram-3M52JZNH.js","assets/0.0.1/gitGraphDiagram-GW3U2K7C.js","assets/0.0.1/chunk-353BL4L5.js","assets/0.0.1/chunk-AACKK3MU.js","assets/0.0.1/treemap-75Q7IDZK.js","assets/0.0.1/ganttDiagram-EK5VF46D.js","assets/0.0.1/infoDiagram-LHK5PUON.js","assets/0.0.1/pieDiagram-NIOCPIFQ.js","assets/0.0.1/quadrantDiagram-2OG54O6I.js","assets/0.0.1/xychartDiagram-H2YORKM3.js","assets/0.0.1/requirementDiagram-QOLK2EJ7.js","assets/0.0.1/sequenceDiagram-SKLFT4DO.js","assets/0.0.1/classDiagram-M3E45YP4.js","assets/0.0.1/chunk-SZ463SBG.js","assets/0.0.1/classDiagram-v2-YAWTLIQI.js","assets/0.0.1/stateDiagram-MI5ZYTHO.js","assets/0.0.1/chunk-OW32GOEJ.js","assets/0.0.1/stateDiagram-v2-5AN5P6BG.js","assets/0.0.1/journeyDiagram-EWQZEKCU.js","assets/0.0.1/timeline-definition-MYPXXCX6.js","assets/0.0.1/mindmap-definition-6CBA2TL7.js","assets/0.0.1/cytoscape.esm.js","assets/0.0.1/kanban-definition-ZSS6B67P.js","assets/0.0.1/sankeyDiagram-4UZDY2LN.js","assets/0.0.1/diagram-5UYTHUR4.js","assets/0.0.1/diagram-ZTM2IBQH.js","assets/0.0.1/blockDiagram-6J76NXCF.js","assets/0.0.1/architectureDiagram-SUXI7LT5.js","assets/0.0.1/diagram-VMROVX33.js"])))=>i.map(i=>d[i]);
var _a, _b, _c, _d, _e2, _f, _g, _h, _i;
import { r as requireDayjs_min, g as getDefaultExportFromCjs, m as memoize, a as merge$1, i as isEmpty } from "./utils-vendor.js";
...
const Channel = {
  ...
  hsl2rgb: ({ h: h2, s: s2, l: l4 }, channel2) => {
    if (!s2)
      return l4 * 2.55;
    h2 /= 360;
    s2 /= 100;
...
var renderKatex = /* @__PURE__ */ __name(async (text2, config2) => {
  ...
  }
  {
    const { default: katex } = await __vitePreload(async () => {
      const { default: katex2 } = await import("./katex-vendor.js");
...
function codePointAt(string, pos) {
  var first = string.charCodeAt(pos), second2;
  if (first >= 55296 && first <= 56319 && pos + 1 < string.length) {
    second2 = string.charCodeAt(pos + 1);
...
function writeFlowMapping(state2, level, object2) {
  var _result = "", _tag = state2.tag, objectKeyList = Object.keys(object2), index, length2, objectKey, objectValue, pairBuffer;
...
function writeBlockMapping(state2, level, object2, compact) {
  var _result = "", _tag = state2.tag, objectKeyList = Object.keys(object2), index, length2, objectKey, objectValue, explicitPair, pairBuffer;
  ...
  function axis2(context) {
    ...
    if (context !== selection2) {
      ...
      tickExit = tickExit.transition(context).attr("opacity", epsilon$2).attr("transform", function(d2) {
        return isFinite(d2 = position2(d2)) ? transform2(d2 + offset) : this.getAttribute("transform");
      });
      tickEnter.attr("opacity", epsilon$2).attr("transform", function(d2) {
        var p2 = this.parentNode.__axis;
        return transform2((p2 && isFinite(p2 = p2(d2)) ? p2 : position2(d2)) + offset);
      });
    }
    tickExit.remove();
    ...
    tick.attr("opacity", 1).attr("transform", function(d2) {
      return transform2(position2(d2) + offset);
    });
...
function drag() {
  ...
  drag2.filter = function(_2) {
    return arguments.length ? (filter2 = typeof _2 === "function" ? _2 : constant$4(!!_2), drag2) : filter2;
  };
  drag2.container = function(_2) {
    return arguments.length ? (container = typeof _2 === "function" ? _2 : constant$4(_2), drag2) : container;
  };
  drag2.subject = function(_2) {
    return arguments.length ? (subject = typeof _2 === "function" ? _2 : constant$4(_2), drag2) : subject;
  };
  drag2.touchable = function(_2) {
    return arguments.length ? (touchable = typeof _2 === "function" ? _2 : constant$4(!!_2), drag2) : touchable;
  };
  drag2.on = function() {
...
const K$2 = 18, Xn = 0.96422, Yn = 1, Zn = 0.82521, t0$1 = 4 / 29, t1$1 = 6 / 29, t2 = 3 * t1$1 * t1$1, t3 = t1$1 * t1$1 * t1$1;
function labConvert(o2) {
  ...
  var r2 = rgb2lrgb(o2.r), g2 = rgb2lrgb(o2.g), b2 = rgb2lrgb(o2.b), y3 = xyz2lab((0.2225045 * r2 + 0.7168786 * g2 + 0.0606169 * b2) / Yn), x2, z2;
  if (r2 === g2 && g2 === b2) x2 = z2 = y3;
  else {
...
function lab(l4, a2, b2, opacity) {
  return arguments.length === 1 ? labConvert(l4) : new Lab(l4, a2, b2, opacity == null ? 1 : opacity);
}
function Lab(l4, a2, b2, opacity) {
  this.l = +l4;
  this.a = +a2;
...
function hcl$1(h2, c2, l4, opacity) {
  return arguments.length === 1 ? hclConvert(h2) : new Hcl(h2, c2, l4, opacity == null ? 1 : opacity);
}
function Hcl(h2, c2, l4, opacity) {
  this.h = +h2;
  this.c = +c2;
  this.l = +l4;
  this.opacity = +opacity;
...
function exponential(a2, b2, y3) {
  return a2 = Math.pow(a2, y3), b2 = Math.pow(b2, y3) - a2, y3 = 1 / y3, function(t4) {
    return Math.pow(a2 + t4 * b2, y3);
  };
}
function hue(a2, b2) {
  var d2 = b2 - a2;
  return d2 ? linear$1(a2, d2 > 180 || d2 < -180 ? d2 - 360 * Math.round(d2 / 360) : d2) : constant$3(isNaN(a2) ? b2 : a2);
}
function gamma(y3) {
  return (y3 = +y3) === 1 ? nogamma : function(a2, b2) {
    return b2 - a2 ? exponential(a2, b2, y3) : constant$3(isNaN(a2) ? b2 : a2);
  };
}
function nogamma(a2, b2) {
  var d2 = b2 - a2;
  return d2 ? linear$1(a2, d2) : constant$3(isNaN(a2) ? b2 : a2);
}
...
const interpolateZoom = function zoomRho(rho, rho2, rho4) {
  function zoom2(p0, p1) {
    var ux0 = p0[0], uy0 = p0[1], w0 = p0[2], ux1 = p1[0], uy1 = p1[1], w1 = p1[2], dx = ux1 - ux0, dy = uy1 - uy0, d2 = dx * dx + dy * dy, i2, S3;
    if (d2 < epsilon2) {
      ...
      S3 = (r1 - r0) / rho;
      i2 = function(t4) {
        var s2 = t4 * S3, coshr0 = cosh(r0), u2 = w0 / (rho2 * d1) * (coshr0 * tanh(rho * s2 + r0) - sinh(r0));
        return [
          ux0 + u2 * dx,
          uy0 + u2 * dy,
...
function hcl(hue2) {
  return function(start2, end) {
    var h2 = hue2((start2 = hcl$1(start2)).h, (end = hcl$1(end)).h), c2 = nogamma(start2.c, end.c), l4 = nogamma(start2.l, end.l), opacity = nogamma(start2.opacity, end.opacity);
    return function(t4) {
      start2.h = h2(t4);
      start2.c = c2(t4);
      start2.l = l4(t4);
...
function create(node2, id28, self) {
  ...
  function start2(elapsed) {
    ...
    for (i2 = 0, j2 = -1; i2 < n2; ++i2) {
      if (o2 = self.tween[i2].value.call(node2, node2.__data__, self.index, self.group)) {
        tween[++j2] = o2;
      }
    }
    tween.length = j2 + 1;
  ...
  function tick(elapsed) {
    var t4 = elapsed < self.duration ? self.ease.call(null, elapsed / self.duration) : (self.timer.restart(stop), self.state = ENDING, 1), i2 = -1, n2 = tween.length;
    while (++i2 < n2) {
...
function add(tree, x2, y3, d2) {
  if (isNaN(x2) || isNaN(y3)) return tree;
  var parent, node2 = tree._root, leaf = { data: d2 }, x0 = tree._x0, y0 = tree._y0, x1 = tree._x1, y1 = tree._y1, xm, ym, xp, yp, right2, bottom2, i2, j2;
  ...
  while (node2.length) {
    ...
    if (parent = node2, !(node2 = node2[i2 = bottom2 << 1 | right2])) return parent[i2] = leaf, tree;
  }
  xp = +tree._x.call(null, node2.data);
  yp = +tree._y.call(null, node2.data);
  if (x2 === xp && y3 === yp) return leaf.next = node2, parent ? parent[i2] = leaf : tree._root = leaf, tree;
  do {
...
function addAll(data) {
  var d2, i2, n2 = data.length, x2, y3, xz = new Array(n2), yz = new Array(n2), x0 = Infinity, y0 = Infinity, x1 = -Infinity, y1 = -Infinity;
  for (i2 = 0; i2 < n2; ++i2) {
    if (isNaN(x2 = +this._x.call(null, d2 = data[i2])) || isNaN(y3 = +this._y.call(null, d2))) continue;
    xz[i2] = x2;
    yz[i2] = y3;
    if (x2 < x0) x0 = x2;
    if (x2 > x1) x1 = x2;
...
function tree_cover(x2, y3) {
  if (isNaN(x2 = +x2) || isNaN(y3 = +y3)) return this;
...
function tree_find(x2, y3, radius) {
  var data, x0 = this._x0, y0 = this._y0, x1, y1, x22, y22, x3 = this._x1, y32 = this._y1, quads = [], node2 = this._root, q2, i2;
  if (node2) quads.push(new Quad(node2, x0, y0, x3, y32));
  ...
  while (q2 = quads.pop()) {
    if (!(node2 = q2.node) || (x1 = q2.x0) > x3 || (y1 = q2.y0) > y32 || (x22 = q2.x1) < x0 || (y22 = q2.y1) < y0) continue;
    if (node2.length) {
      ...
      var dx = x2 - +this._x.call(null, node2.data), dy = y3 - +this._y.call(null, node2.data), d2 = dx * dx + dy * dy;
      if (d2 < radius) {
...
function tree_remove(d2) {
  if (isNaN(x2 = +this._x.call(null, d2)) || isNaN(y3 = +this._y.call(null, d2))) return this;
  var parent, node2 = this._root, retainer, previous, next2, x0 = this._x0, y0 = this._y0, x1 = this._x1, y1 = this._y1, x2, y3, xm, ym, right2, bottom2, i2, j2;
  ...
  if (node2.length) while (true) {
    ...
    if (!(parent = node2, node2 = node2[i2 = bottom2 << 1 | right2])) return this;
...
function node_eachBefore(callback, that) {
  var node2 = this, nodes = [node2], children2, i2, index = -1;
  while (node2 = nodes.pop()) {
    callback.call(that, node2, ++index, this);
...
function node_eachAfter(callback, that) {
  var node2 = this, nodes = [node2], next2 = [], children2, i2, n2, index = -1;
  while (node2 = nodes.pop()) {
    next2.push(node2);
    if (children2 = node2.children) {
...
function node_sum(value) {
  return this.eachAfter(function(node2) {
    var sum2 = +value(node2.data) || 0, children2 = node2.children, i2 = children2 && children2.length;
...
function hierarchy(data, children2) {
  ...
  var root2 = new Node(data), node2, nodes = [root2], child, childs, i2, n2;
  while (node2 = nodes.pop()) {
...
function transformer() {
  var domain = unit, range2 = unit, interpolate2 = interpolate$1, transform2, untransform, unknown, clamp = identity$2, piecewise, output, input;
  function rescale() {
  ...
  function scale(x2) {
    return x2 == null || isNaN(x2 = +x2) ? unknown : (output || (output = piecewise(domain.map(transform2), range2, interpolate2)))(transform2(clamp(x2)));
  }
  scale.invert = function(y3) {
    return clamp(untransform((input || (input = piecewise(range2, domain.map(transform2), interpolateNumber)))(y3)));
  };
  scale.domain = function(_2) {
...
function formatLocale(locale2) {
  ...
  function parseSpecifier(d2, specifier, string, j2) {
    var i2 = 0, n2 = specifier.length, m2 = string.length, c2, parse3;
    while (i2 < n2) {
      if (j2 >= m2) return -1;
      ...
      if (c2 === 37) {
        ...
        if (!parse3 || (j2 = parse3(d2, string, j2)) < 0) return -1;
...
function intersect(x0, y0, x1, y1, x2, y22, x3, y3) {
  var x10 = x1 - x0, y10 = y1 - y0, x32 = x3 - x2, y32 = y3 - y22, t4 = y32 * x10 - x32 * y10;
  if (t4 * t4 < epsilon) return;
  t4 = (x32 * (y0 - y22) - y32 * (x0 - x2)) / t4;
...
function d3arc() {
  ...
  function arc() {
    var buffer, r2, r0 = +innerRadius.apply(this, arguments), r1 = +outerRadius.apply(this, arguments), a0 = startAngle.apply(this, arguments) - halfPi, a1 = endAngle.apply(this, arguments) - halfPi, da = abs$1(a1 - a0), cw = a1 > a0;
...
function d3pie() {
  ...
  function pie2(data) {
    var i2, n2 = (data = array(data)).length, j2, k2, sum2 = 0, index = new Array(n2), arcs = new Array(n2), a0 = +startAngle.apply(this, arguments), da = Math.min(tau, Math.max(-tau, endAngle.apply(this, arguments) - a0)), a1, p2 = Math.min(Math.abs(da) / n2, padAngle.apply(this, arguments)), pa = p2 * (da < 0 ? -1 : 1), v2;
    for (i2 = 0; i2 < n2; ++i2) {
...
Bundle.prototype = {
  ...
  lineEnd: function() {
    ...
    if (j2 > 0) {
      var x0 = x2[0], y0 = y3[0], dx = x2[j2] - x0, dy = y3[j2] - y0, i2 = -1, t4;
      while (++i2 <= j2) {
        t4 = i2 / j2;
        this._basis.point(
...
MonotoneX.prototype = {
  ...
  point: function(x2, y3) {
    ...
    switch (this._point) {
      ...
      case 2:
        this._point = 3;
        point$1(this, slope2(this, t12 = slope3(this, x2, y3)), t12);
        break;
      default:
        point$1(this, this._t0, t12 = slope3(this, x2, y3));
        break;
    }
    this._x0 = this._x1, this._x1 = x2;
    this._y0 = this._y1, this._y1 = y3;
...
function zoom() {
  ...
  zoom2.scaleTo = function(selection2, k2, p2, event) {
    zoom2.transform(selection2, function() {
      var e3 = extent.apply(this, arguments), t02 = this.__zoom, p0 = p2 == null ? centroid(e3) : typeof p2 === "function" ? p2.apply(this, arguments) : p2, p1 = t02.invert(p0), k1 = typeof k2 === "function" ? k2.apply(this, arguments) : k2;
      return constrain(translate(scale(t02, k1), p0, p1), e3, translateExtent);
    }, p2, event);
  };
  zoom2.translateBy = function(selection2, x2, y3, event) {
    zoom2.transform(selection2, function() {
  ...
  zoom2.translateTo = function(selection2, x2, y3, p2, event) {
    zoom2.transform(selection2, function() {
      var e3 = extent.apply(this, arguments), t4 = this.__zoom, p0 = p2 == null ? centroid(e3) : typeof p2 === "function" ? p2.apply(this, arguments) : p2;
      return constrain(identity.translate(p0[0], p0[1]).scale(t4.k).translate(
        typeof x2 === "function" ? -x2.apply(this, arguments) : -x2,
        typeof y3 === "function" ? -y3.apply(this, arguments) : -y3
      ), e3, translateExtent);
    }, p2, event);
  ...
  function schedule2(transition, transform2, point2, event) {
    transition.on("start.zoom", function() {
      ...
      var that = this, args = arguments, g2 = gesture(that, args).event(event), e3 = extent.apply(that, args), p2 = point2 == null ? centroid(e3) : typeof point2 === "function" ? point2.apply(that, args) : point2, w2 = Math.max(e3[1][0] - e3[0][0], e3[1][1] - e3[0][1]), a2 = that.__zoom, b2 = typeof transform2 === "function" ? transform2.apply(that, args) : transform2, i2 = interpolate2(a2.invert(p2).concat(w2 / a2.k), b2.invert(p2).concat(w2 / b2.k));
      return function(t4) {
        if (t4 === 1) t4 = b2;
        else {
          var l4 = i2(t4), k2 = w2 / l4[2];
          t4 = new Transform(k2, p2[0] - l4[0] * k2, p2[1] - l4[1] * k2);
        }
        g2.zoom(null, t4);
      };
    });
  ...
  function wheeled(event, ...args) {
    ...
    var g2 = gesture(this, args).event(event), t4 = this.__zoom, k2 = Math.max(scaleExtent[0], Math.min(scaleExtent[1], t4.k * Math.pow(2, wheelDelta.apply(this, arguments)))), p2 = pointer(event);
    if (g2.wheel) {
  ...
  function touchstarted(event, ...args) {
    ...
    nopropagation(event);
    for (i2 = 0; i2 < n2; ++i2) {
      t4 = touches[i2], p2 = pointer(t4, this);
  ...
  function touchmoved(event, ...args) {
    ...
    var g2 = gesture(this, args).event(event), touches = event.changedTouches, n2 = touches.length, i2, t4, p2, l4;
    noevent(event);
    for (i2 = 0; i2 < n2; ++i2) {
      t4 = touches[i2], p2 = pointer(t4, this);
    ...
    } else if (g2.touch0) p2 = g2.touch0[0], l4 = g2.touch0[1];
    else return;
    g2.zoom("touch", constrain(translate(t4, p2, l4), g2.extent, translateExtent));
  }
...
function V$1(l4, e3) {
  let t4 = l4.replace(m$1.findPipe, (i2, s2, o2) => {
    let a2 = false, u2 = s2;
    for (; --u2 >= 0 && o2[u2] === "\\"; ) a2 = !a2;
    return a2 ? "|" : " |";
  }), n2 = t4.split(m$1.splitPipe), r2 = 0;
...
var y$1 = class y {
  ...
  code(e3) {
    ...
    if (t4) {
      ...
      return { type: "code", raw: t4[0], codeBlockStyle: "indented", text: this.options.pedantic ? n2 : z$1(n2, `
`) };
    }
  }
  fences(e3) {
  ...
  hr(e3) {
    ...
    if (t4) return { type: "hr", raw: z$1(t4[0], `
`) };
  }
  blockquote(e3) {
...
${c2}` : c2;
        ...
        if (k2?.type === "blockquote") {
          let x2 = k2, g2 = x2.raw + `
` + n2.join(`
`), T2 = this.blockquote(g2);
          s2[s2.length - 1] = T2, r2 = r2.substring(0, r2.length - x2.raw.length) + T2.raw, i2 = i2.substring(0, i2.length - x2.text.length) + T2.text;
          break;
        } else if (k2?.type === "list") {
          let x2 = k2, g2 = x2.raw + `
` + n2.join(`
`), T2 = this.list(g2);
          s2[s2.length - 1] = T2, r2 = r2.substring(0, r2.length - k2.raw.length) + T2.raw, i2 = i2.substring(0, i2.length - x2.raw.length) + T2.raw, n2 = g2.substring(s2.at(-1).raw.length).split(`
`);
          continue;
        }
      }
  ...
  list(e3) {
    ...
    if (t4) {
      ...
      for (; e3; ) {
        ...
        let f2 = t4[2].split(`
`, 1)[0].replace(this.rules.other.listReplaceTabs, (Z2) => " ".repeat(3 * Z2.length)), k2 = e3.split(`
`, 1)[0], x2 = !f2.trim(), g2 = 0;
        if (this.options.pedantic ? (g2 = 2, c2 = f2.trimStart()) : x2 ? g2 = t4[1].length + 1 : (g2 = t4[2].search(this.rules.other.nonSpaceChar), g2 = g2 > 4 ? 1 : g2, c2 = f2.slice(g2), g2 += t4[1].length), x2 && this.rules.other.blankLine.test(k2) && (p2 += k2 + `
`, e3 = e3.substring(k2.length + 1), u2 = true), !u2) {
          let Z2 = this.rules.other.nextBulletRegex(g2), ee = this.rules.other.hrRegex(g2), te = this.rules.other.fencesBeginRegex(g2), ne = this.rules.other.headingBeginRegex(g2), me = this.rules.other.htmlBeginRegex(g2);
          for (; e3; ) {
            let G2 = e3.split(`
`, 1)[0], A2;
            if (k2 = G2, this.options.pedantic ? (k2 = k2.replace(this.rules.other.listReplaceNesting, "  "), A2 = k2) : A2 = k2.replace(this.rules.other.tabCharGlobal, "    "), te.test(k2) || ne.test(k2) || me.test(k2) || Z2.test(k2) || ee.test(k2)) break;
            if (A2.search(this.rules.other.nonSpaceChar) >= g2 || !k2.trim()) c2 += `
` + A2.slice(g2);
            else {
              if (x2 || f2.replace(this.rules.other.tabCharGlobal, "    ").search(this.rules.other.nonSpaceChar) >= 4 || te.test(f2) || ne.test(f2) || ee.test(f2)) break;
              c2 += `
` + k2;
            }
            !x2 && !k2.trim() && (x2 = true), p2 += G2 + `
`, e3 = e3.substring(G2.length + 1), f2 = A2.slice(g2);
          }
        }
        i2.loose || (o2 ? i2.loose = true : this.rules.other.doubleBlankLine.test(p2) && (o2 = true));
        let T2 = null, Y2;
        this.options.gfm && (T2 = this.rules.other.listIsTask.exec(c2), T2 && (Y2 = T2[0] !== "[ ] ", c2 = c2.replace(this.rules.other.listReplaceTask, ""))), i2.items.push({ type: "list_item", raw: p2, task: !!T2, checked: Y2, loose: false, text: c2, tokens: [] }), i2.raw += p2;
      }
      ...
      for (let u2 = 0; u2 < i2.items.length; u2++) if (this.lexer.state.top = false, i2.items[u2].tokens = this.lexer.blockTokens(i2.items[u2].text, []), !i2.loose) {
        let p2 = i2.items[u2].tokens.filter((f2) => f2.type === "space"), c2 = p2.length > 0 && p2.some((f2) => this.rules.other.anyLine.test(f2.raw));
        i2.loose = c2;
      }
  ...
  table(e3) {
    ...
    let n2 = V$1(t4[1]), r2 = t4[2].replace(this.rules.other.tableAlignChars, "").split("|"), i2 = t4[3]?.trim() ? t4[3].replace(this.rules.other.tableRowBlankLine, "").split(`
`) : [], s2 = { type: "table", raw: t4[0], header: [], align: [], rows: [] };
    if (n2.length === r2.length) {
      ...
      for (let o2 of i2) s2.rows.push(V$1(o2, s2.header.length).map((a2, u2) => ({ text: a2, tokens: this.lexer.inline(a2), header: false, align: s2.align[u2] })));
      return s2;
    }
  }
  lheading(e3) {
...
` ? t4[1].slice(0, -1) : t4[1];
  ...
  emStrong(e3, t4, n2 = "") {
    ...
    if (!(r2[1] || r2[2] || "") || !n2 || this.rules.inline.punctuation.exec(n2)) {
      let s2 = [...r2[0]].length - 1, o2, a2, u2 = s2, p2 = 0, c2 = r2[0][0] === "*" ? this.rules.inline.emStrongRDelimAst : this.rules.inline.emStrongRDelimUnd;
...
var b$1 = class l {
  ...
  inlineQueue;
  constructor(e3) {
    this.tokens = [], this.tokens.links = /* @__PURE__ */ Object.create(null), this.options = e3 || O$1, this.options.tokenizer = this.options.tokenizer || new y$1(), this.tokenizer = this.options.tokenizer, this.tokenizer.options = this.options, this.tokenizer.lexer = this, this.inlineQueue = [], this.state = { inLink: false, inRawBlock: false, top: true };
    let t4 = { other: m$1, block: I$1.normal, inline: M$1.normal };
    this.options.pedantic ? (t4.block = I$1.pedantic, t4.inline = M$1.pedantic) : this.options.gfm && (t4.block = I$1.gfm, this.options.breaks ? t4.inline = M$1.breaks : t4.inline = M$1.gfm), this.tokenizer.rules = t4;
  }
  static get rules() {
    return { block: I$1, inline: M$1 };
  }
  static lex(e3, t4) {
  ...
  lex(e3) {
    e3 = e3.replace(m$1.carriageReturn, `
`), this.blockTokens(e3, this.tokens);
  ...
  blockTokens(e3, t4 = [], n2 = false) {
    for (this.options.pedantic && (e3 = e3.replace(m$1.tabCharGlobal, "    ").replace(m$1.spaceLine, "")); e3; ) {
      let r2;
...
` : t4.push(r2);
      ...
      if (r2 = this.tokenizer.code(e3)) {
        e3 = e3.substring(r2.raw.length);
        let s2 = t4.at(-1);
        s2?.type === "paragraph" || s2?.type === "text" ? (s2.raw += `
` + r2.raw, s2.text += `
` + r2.text, this.inlineQueue.at(-1).src = s2.text) : t4.push(r2);
      ...
      if (r2 = this.tokenizer.def(e3)) {
        ...
        s2?.type === "paragraph" || s2?.type === "text" ? (s2.raw += `
` + r2.raw, s2.text += `
` + r2.raw, this.inlineQueue.at(-1).src = s2.text) : this.tokens.links[r2.tag] || (this.tokens.links[r2.tag] = { href: r2.href, title: r2.title });
        continue;
      }
...
var P$1 = class P {
  ...
  code({ text: e3, lang: t4, escaped: n2 }) {
    let r2 = (t4 || "").match(m$1.notSpaceStart)?.[0], i2 = e3.replace(m$1.endingNewline, "") + `
`;
...
`;
  ...
  listitem(e3) {
    ...
    if (e3.task) {
      ...
      e3.loose ? e3.tokens[0]?.type === "paragraph" ? (e3.tokens[0].text = n2 + " " + e3.tokens[0].text, e3.tokens[0].tokens && e3.tokens[0].tokens.length > 0 && e3.tokens[0].tokens[0].type === "text" && (e3.tokens[0].tokens[0].text = n2 + " " + w$1(e3.tokens[0].tokens[0].text), e3.tokens[0].tokens[0].escaped = true)) : e3.tokens.unshift({ type: "text", raw: n2 + " ", text: n2 + " ", escaped: true }) : t4 += n2 + " ";
    }
...
`;
  ...
  link({ href: e3, title: t4, tokens: n2 }) {
    let r2 = this.parser.parseInline(n2), i2 = J$1(e3);
    if (i2 === null) return r2;
    e3 = i2;
    let s2 = '<a href="' + e3 + '"';
    return t4 && (s2 += ' title="' + w$1(t4) + '"'), s2 += ">" + r2 + "</a>", s2;
  }
  image({ href: e3, title: t4, text: n2, tokens: r2 }) {
    ...
    return t4 && (s2 += ` title="${w$1(t4)}"`), s2 += ">", s2;
  }
  text(e3) {
    return "tokens" in e3 && e3.tokens ? this.parser.parseInline(e3.tokens) : "escaped" in e3 && e3.escaped ? e3.text : w$1(e3.text);
  }
};
var S$1 = class S {
  strong({ text: e3 }) {
...
var R$1 = class l2 {
  ...
  textRenderer;
  constructor(e3) {
    this.options = e3 || O$1, this.options.renderer = this.options.renderer || new P$1(), this.renderer = this.options.renderer, this.renderer.options = this.options, this.renderer.parser = this, this.textRenderer = new S$1();
  }
  static parse(e3, t4) {
  ...
  parse(e3, t4 = true) {
    ...
    for (let r2 = 0; r2 < e3.length; r2++) {
      ...
      if (this.options.extensions?.renderers?.[i2.type]) {
        ...
        if (a2 !== false || !["space", "hr", "heading", "code", "table", "blockquote", "list", "html", "paragraph", "text"].includes(o2.type)) {
          n2 += a2 || "";
          continue;
        }
      }
...
var $$1 = class $ {
  ...
  provideLexer() {
    return this.block ? b$1.lex : b$1.lexInline;
  }
  provideParser() {
    return this.block ? R$1.parse : R$1.parseInline;
  }
};
var B$1 = class B {
  defaults = L$1();
  ...
  use(...e3) {
    ...
    return e3.forEach((n2) => {
      ...
      if (n2.hooks) {
        let i2 = this.defaults.hooks || new $$1();
        for (let s2 in n2.hooks) {
          if (!(s2 in i2)) throw new Error(`hook '${s2}' does not exist`);
          if (["options", "block"].includes(s2)) continue;
          let o2 = s2, a2 = n2.hooks[o2], u2 = i2[o2];
          $$1.passThroughHooks.has(s2) ? i2[o2] = (p2) => {
            if (this.defaults.async) return Promise.resolve(a2.call(i2, p2)).then((f2) => u2.call(i2, f2));
  ...
  lexer(e3, t4) {
    return b$1.lex(e3, t4 ?? this.defaults);
  }
  parser(e3, t4) {
    return R$1.parse(e3, t4 ?? this.defaults);
  }
  parseMarkdown(e3) {
    return (n2, r2) => {
      ...
      let a2 = s2.hooks ? s2.hooks.provideLexer() : e3 ? b$1.lex : b$1.lexInline, u2 = s2.hooks ? s2.hooks.provideParser() : e3 ? R$1.parse : R$1.parseInline;
      if (s2.async) return Promise.resolve(s2.hooks ? s2.hooks.preprocess(n2) : n2).then((p2) => a2(p2, s2)).then((p2) => s2.hooks ? s2.hooks.processAllTokens(p2) : p2).then((p2) => s2.walkTokens ? Promise.all(this.walkTokens(p2, s2.walkTokens)).then(() => p2) : p2).then((p2) => u2(p2, s2)).then((p2) => s2.hooks ? s2.hooks.postprocess(p2) : p2).catch(o2);
      try {
...
var _$1 = new B$1();
function d$1(l4, e3) {
  return _$1.parse(l4, e3);
}
d$1.options = d$1.setOptions = function(l4) {
  return _$1.setOptions(l4), d$1.defaults = _$1.defaults, H$1(d$1.defaults), d$1;
};
d$1.getDefaults = L$1;
d$1.defaults = O$1;
d$1.use = function(...l4) {
  return _$1.use(...l4), d$1.defaults = _$1.defaults, H$1(d$1.defaults), d$1;
};
d$1.walkTokens = function(l4, e3) {
  return _$1.walkTokens(l4, e3);
};
d$1.parseInline = _$1.parseInline;
d$1.Parser = R$1;
d$1.parser = R$1.parse;
d$1.Renderer = P$1;
d$1.TextRenderer = S$1;
d$1.Lexer = b$1;
d$1.lexer = b$1.lex;
d$1.Tokenizer = y$1;
d$1.Hooks = $$1;
...
class i {
  ...
  dotsOnLines(t4, e3) {
    ...
    const h2 = n2 / 4;
    for (const r2 of t4) {
      const t5 = a(r2), i2 = t5 / n2, c2 = Math.ceil(i2) - 1, l4 = t5 - c2 * n2, u2 = (r2[0][0] + r2[1][0]) / 2 - n2 / 4, p2 = Math.min(r2[0][1], r2[1][1]);
      for (let t6 = 0; t6 < c2; t6++) {
        const a2 = p2 + l4 + t6 * n2, r3 = u2 - h2 + 2 * Math.random() * h2, i3 = a2 - h2 + 2 * Math.random() * h2, c3 = this.helper.ellipse(r3, i3, o2, o2, e3);
        s2.push(...c3.ops);
      }
    }
...
class c {
  ...
  dashedLine(t4, e3) {
    ...
    return t4.forEach((t5) => {
      ...
      let c2 = t5[0], l4 = t5[1];
      c2[0] > l4[0] && (c2 = t5[1], l4 = t5[0]);
      const u2 = Math.atan((l4[1] - c2[1]) / (l4[0] - c2[0]));
      for (let t6 = 0; t6 < r2; t6++) {
        const a2 = t6 * (s2 + n2), h3 = a2 + s2, r3 = [c2[0] + a2 * Math.cos(u2) + i2 * Math.cos(u2), c2[1] + a2 * Math.sin(u2) + i2 * Math.sin(u2)], l5 = [c2[0] + h3 * Math.cos(u2) + i2 * Math.cos(u2), c2[1] + h3 * Math.sin(u2) + i2 * Math.sin(u2)];
  ...
  zigzagLines(t4, e3, s2) {
    ...
    return t4.forEach((t5) => {
      ...
      for (let t6 = 0; t6 < h2; t6++) {
        const o3 = 2 * t6 * e3, a2 = 2 * (t6 + 1) * e3, h3 = Math.sqrt(2 * Math.pow(e3, 2)), i3 = [r2[0] + o3 * Math.cos(c2), r2[1] + o3 * Math.sin(c2)], l4 = [r2[0] + a2 * Math.cos(c2), r2[1] + a2 * Math.sin(c2)], u2 = [i3[0] + h3 * Math.cos(c2 + Math.PI / 4), i3[1] + h3 * Math.sin(c2 + Math.PI / 4)];
...
function m(t4) {
  ...
  for (const { key: c2, data: l4 } of t4) {
    switch (c2) {
      case "M":
        e3.push({ key: "M", data: [...l4] }), [n2, o2] = l4, [a2, h2] = l4;
        break;
      case "C":
      ...
      case "Q": {
        const [t5, s3, a3, h3] = l4, c3 = n2 + 2 * (t5 - n2) / 3, u2 = o2 + 2 * (s3 - o2) / 3, p2 = a3 + 2 * (t5 - a3) / 3, f2 = h3 + 2 * (s3 - h3) / 3;
        e3.push({ key: "C", data: [c3, u2, p2, f2, a3, h3] }), r2 = t5, i2 = s3, n2 = a3, o2 = h3;
        break;
      }
      case "A": {
        const t5 = Math.abs(l4[0]), s3 = Math.abs(l4[1]), a3 = l4[2], h3 = l4[3], r3 = l4[4], i3 = l4[5], c3 = l4[6];
...
function x(t4, e3, s2, n2, o2, a2, h2, r2, i2, c2) {
  ...
  if (c2) [f2, d2, g2, M2] = c2;
    ...
    [t4, e3] = w(t4, e3, -l4), [s2, n2] = w(s2, n2, -l4);
  ...
  k2 = d2 - f2;
  const b2 = Math.cos(f2), y3 = Math.sin(f2), m2 = Math.cos(d2), P3 = Math.sin(d2), v2 = Math.tan(k2 / 4), S3 = 4 / 3 * o2 * v2, O2 = 4 / 3 * a2 * v2, L2 = [t4, e3], T2 = [t4 + S3 * y3, e3 - O2 * b2], D2 = [s2 + S3 * P3, n2 - O2 * m2], A2 = [s2, n2];
  if (T2[0] = 2 * L2[0] - T2[0], T2[1] = 2 * L2[1] - T2[1], c2) return [T2, D2, A2].concat(p2);
  {
    p2 = [T2, D2, A2].concat(p2);
    const t5 = [];
    for (let e4 = 0; e4 < p2.length; e4 += 3) {
      const s3 = w(p2[e4][0], p2[e4][1], l4), n3 = w(p2[e4 + 1][0], p2[e4 + 1][1], l4), o3 = w(p2[e4 + 2][0], p2[e4 + 2][1], l4);
      t5.push([s3[0], s3[1], n3[0], n3[1], o3[0], o3[1]]);
    }
    return t5;
  }
}
const P2 = { randOffset: function(t4, e3) {
  return G(t4, e3);
...
function A(t4, e3, s2, n2, o2, a2, h2, r2, i2) {
  ...
  if (!i2.disableMultiStroke) {
    const t5 = V(M2, c2, l4, u2, p2, f2, d2, 1.5, i2);
    k2.push(...t5);
  }
...
function _(t4, e3) {
  ...
  for (const { key: t5, data: h2 } of s2) switch (t5) {
    case "M":
      ...
      break;
    case "L":
      n2.push(...$2(a2[0], a2[1], h2[0], h2[1], e3)), a2 = [h2[0], h2[1]];
      break;
    case "C": {
...
function R(t4, e3, s2, n2, o2, a2, h2) {
  ...
  return h2 ? g2.push({ op: "move", data: [t4 + (b2 ? 0 : M2()), e3 + (b2 ? 0 : M2())] }) : g2.push({ op: "move", data: [t4 + (b2 ? 0 : G(l4, o2, c2)), e3 + (b2 ? 0 : G(l4, o2, c2))] }), h2 ? g2.push({ op: "bcurveTo", data: [f2 + t4 + (s2 - t4) * p2 + M2(), d2 + e3 + (n2 - e3) * p2 + M2(), f2 + t4 + 2 * (s2 - t4) * p2 + M2(), d2 + e3 + 2 * (n2 - e3) * p2 + M2(), s2 + (b2 ? 0 : M2()), n2 + (b2 ? 0 : M2())] }) : g2.push({ op: "bcurveTo", data: [f2 + t4 + (s2 - t4) * p2 + k2(), d2 + e3 + (n2 - e3) * p2 + k2(), f2 + t4 + 2 * (s2 - t4) * p2 + k2(), d2 + e3 + 2 * (n2 - e3) * p2 + k2(), s2 + (b2 ? 0 : k2()), n2 + (b2 ? 0 : k2())] }), g2;
}
function j(t4, e3, s2) {
  if (!t4.length) return [];
  const n2 = [];
...
function F(t4, e3, s2, n2, o2, a2, h2, r2) {
  ...
  if (0 === r2.roughness) {
    ...
    c2.push([G(a2, r2) + e3 + 0.9 * n2 * Math.cos(l4 - t4), G(a2, r2) + s2 + 0.9 * o2 * Math.sin(l4 - t4)]);
    const u2 = 2 * Math.PI + l4 - 0.01;
    for (let h3 = l4; h3 < u2; h3 += t4) {
      const t5 = [G(a2, r2) + e3 + n2 * Math.cos(h3), G(a2, r2) + s2 + o2 * Math.sin(h3)];
      i2.push(t5), c2.push(t5);
    }
    c2.push([G(a2, r2) + e3 + n2 * Math.cos(l4 + 2 * Math.PI + 0.5 * h2), G(a2, r2) + s2 + o2 * Math.sin(l4 + 2 * Math.PI + 0.5 * h2)]), c2.push([G(a2, r2) + e3 + 0.98 * n2 * Math.cos(l4 + h2), G(a2, r2) + s2 + 0.98 * o2 * Math.sin(l4 + h2)]), c2.push([G(a2, r2) + e3 + 0.9 * n2 * Math.cos(l4 + 0.5 * h2), G(a2, r2) + s2 + 0.9 * o2 * Math.sin(l4 + 0.5 * h2)]);
  }
  return [c2, i2];
}
function V(t4, e3, s2, n2, o2, a2, h2, r2, i2) {
  const c2 = a2 + G(0.1, i2), l4 = [];
  l4.push([G(r2, i2) + e3 + 0.9 * n2 * Math.cos(c2 - t4), G(r2, i2) + s2 + 0.9 * o2 * Math.sin(c2 - t4)]);
  for (let a3 = c2; a3 <= h2; a3 += t4) l4.push([G(r2, i2) + e3 + n2 * Math.cos(a3), G(r2, i2) + s2 + o2 * Math.sin(a3)]);
  return l4.push([e3 + n2 * Math.cos(h2), s2 + o2 * Math.sin(h2)]), l4.push([e3 + n2 * Math.cos(h2), s2 + o2 * Math.sin(h2)]), q(l4, null, i2);
}
function Z(t4, e3, s2, n2, o2, a2, h2, r2) {
  ...
  for (let f2 = 0; f2 < u2; f2++) 0 === f2 ? i2.push({ op: "move", data: [h2[0], h2[1]] }) : i2.push({ op: "move", data: [h2[0] + (p2 ? 0 : G(c2[0], r2)), h2[1] + (p2 ? 0 : G(c2[0], r2))] }), l4 = p2 ? [o2, a2] : [o2 + G(c2[f2], r2), a2 + G(c2[f2], r2)], i2.push({ op: "bcurveTo", data: [t4 + G(c2[f2], r2), e3 + G(c2[f2], r2), s2 + G(c2[f2], r2), n2 + G(c2[f2], r2), l4[0], l4[1]] });
  return i2;
}
function Q(t4) {
  return [...t4];
...
function K(t4, e3, s2, n2) {
  ...
  if (function(t5, e4) {
    ...
    const n3 = 0.5, a3 = t4[e3 + 0], h3 = t4[e3 + 1], r2 = t4[e3 + 2], i2 = t4[e3 + 3], c2 = J(a3, h3, n3), l4 = J(h3, r2, n3), u2 = J(r2, i2, n3), p2 = J(c2, l4, n3), f2 = J(l4, u2, n3), d2 = J(p2, f2, n3);
...
class et {
  ...
  arc(t4, e3, s2, n2, o2, a2, h2 = false, r2) {
    const i2 = this._o(r2), c2 = [], l4 = A(t4, e3, s2, n2, o2, a2, h2, true, i2);
    if (h2 && i2.fill) if ("solid" === i2.fillStyle) {
      ...
      for (let t6 = u2; t6 <= p2; t6 += f2) d2.push([r3 + c3 * Math.cos(t6), i3 + l5 * Math.sin(t6)]);
...
function intersectLine(p1, p2, q1, q2) {
  ...
  num = a2 * c1 - a1 * c2;
  y3 = num < 0 ? (num - offset) / denom : (num + offset) / denom;
  return { x: x2, y: y3 };
}
...
function intersectPolygon(node2, polyPoints, point2) {
  ...
  let left2 = x1 - node2.width / 2 - minX;
...
async function erBox(parent, node2) {
  ...
  shapeSvg.selectAll("g:not(:first-child)").each((_2, i2, nodes) => {
    ...
    const transform2 = text2.attr("transform");
    let translateX2 = 0;
    let translateY2 = 0;
    if (transform2) {
      const regex2 = RegExp(/translate\(([^,]+),([^)]+)\)/);
      const translate = regex2.exec(transform2);
      if (translate) {
        translateX2 = parseFloat(translate[1]);
    ...
    text2.attr(
      "transform",
      `translate(${x2 + PADDING / 2 + translateX2}, ${translateY2 + y3 + nameBBox.height + TEXT_PADDING / 2})`
    );
  });
...
__name(erBox, "erBox");
async function addText(shapeSvg, labelText, config2, translateX2 = 0, translateY2 = 0, classes = [], style = "") {
  const label = shapeSvg.insert("g").attr("class", `label ${classes.join(" ")}`).attr("transform", `translate(${translateX2}, ${translateY2})`).attr("style", style);
...
async function classBox(parent, node2) {
  ...
  shapeSvg.selectAll(".text").each((_2, i2, nodes) => {
    ...
    let newTranslateY = translateY2 + y3 + PADDING - (renderExtraBox ? PADDING : classNode.members.length === 0 && classNode.methods.length === 0 ? -PADDING / 2 : 0);
    if (!useHtmlLabels) {
      newTranslateY -= 4;
    }
...
var registerDefaultLayoutLoaders = /* @__PURE__ */ __name(() => {
  registerLayoutLoaders([
    {
      name: "dagre",
      loader: /* @__PURE__ */ __name(async () => await __vitePreload(() => import("./dagre-JOIXM2OF.js"), true ? __vite__mapDeps([0,1,2,3]) : void 0), "loader")
    }
  ]);
...
var loader = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => {
    const { diagram: diagram22 } = await import("./c4Diagram-6F6E4RAY.js");
    return { diagram: diagram22 };
  }, true ? __vite__mapDeps([4,5,2]) : void 0);
...
var loader2 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => {
    const { diagram: diagram22 } = await import("./flowDiagram-KYDEHFYC.js");
    return { diagram: diagram22 };
  }, true ? __vite__mapDeps([6,7,8,9,2]) : void 0);
...
var loader4 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => {
    const { diagram: diagram22 } = await import("./erDiagram-3M52JZNH.js");
    return { diagram: diagram22 };
  }, true ? __vite__mapDeps([10,8,9,2]) : void 0);
...
var loader5 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => {
    const { diagram: diagram22 } = await import("./gitGraphDiagram-GW3U2K7C.js");
    return { diagram: diagram22 };
  }, true ? __vite__mapDeps([11,12,13,14,2]) : void 0);
...
var loader6 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => {
    const { diagram: diagram22 } = await import("./ganttDiagram-EK5VF46D.js");
    return { diagram: diagram22 };
  }, true ? __vite__mapDeps([15,2]) : void 0);
...
var loader7 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => {
    const { diagram: diagram22 } = await import("./infoDiagram-LHK5PUON.js");
    return { diagram: diagram22 };
  }, true ? __vite__mapDeps([16,14,2]) : void 0);
...
var loader8 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => {
    const { diagram: diagram22 } = await import("./pieDiagram-NIOCPIFQ.js");
    return { diagram: diagram22 };
  }, true ? __vite__mapDeps([17,12,14,2]) : void 0);
...
var loader9 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => {
    const { diagram: diagram22 } = await import("./quadrantDiagram-2OG54O6I.js");
    return { diagram: diagram22 };
  }, true ? __vite__mapDeps([18,2]) : void 0);
...
var loader10 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => {
    const { diagram: diagram22 } = await import("./xychartDiagram-H2YORKM3.js");
    return { diagram: diagram22 };
  }, true ? __vite__mapDeps([19,2]) : void 0);
...
var loader11 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => {
    const { diagram: diagram22 } = await import("./requirementDiagram-QOLK2EJ7.js");
    return { diagram: diagram22 };
  }, true ? __vite__mapDeps([20,8,9,2]) : void 0);
...
var loader12 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => {
    const { diagram: diagram22 } = await import("./sequenceDiagram-SKLFT4DO.js");
    return { diagram: diagram22 };
  }, true ? __vite__mapDeps([21,5,13,2]) : void 0);
...
var loader13 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => {
    const { diagram: diagram22 } = await import("./classDiagram-M3E45YP4.js");
    return { diagram: diagram22 };
  }, true ? __vite__mapDeps([22,23,7,8,9,2]) : void 0);
...
var loader14 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => {
    const { diagram: diagram22 } = await import("./classDiagram-v2-YAWTLIQI.js");
    return { diagram: diagram22 };
  }, true ? __vite__mapDeps([24,23,7,8,9,2]) : void 0);
...
var loader15 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => {
    const { diagram: diagram22 } = await import("./stateDiagram-MI5ZYTHO.js");
    return { diagram: diagram22 };
  }, true ? __vite__mapDeps([25,26,8,9,1,2,3]) : void 0);
...
var loader16 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => {
    const { diagram: diagram22 } = await import("./stateDiagram-v2-5AN5P6BG.js");
    return { diagram: diagram22 };
  }, true ? __vite__mapDeps([27,26,8,9,2]) : void 0);
...
var loader17 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => {
    const { diagram: diagram22 } = await import("./journeyDiagram-EWQZEKCU.js");
    return { diagram: diagram22 };
  }, true ? __vite__mapDeps([28,5,7,2]) : void 0);
...
var loader19 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => {
    const { diagram: diagram22 } = await import("./timeline-definition-MYPXXCX6.js");
    return { diagram: diagram22 };
  }, true ? __vite__mapDeps([29,2]) : void 0);
...
var loader20 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => {
    const { diagram: diagram22 } = await import("./mindmap-definition-6CBA2TL7.js");
    return { diagram: diagram22 };
  }, true ? __vite__mapDeps([30,31,2]) : void 0);
...
var loader21 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => {
    const { diagram: diagram22 } = await import("./kanban-definition-ZSS6B67P.js");
    return { diagram: diagram22 };
  }, true ? __vite__mapDeps([32,7,2]) : void 0);
...
var loader22 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => {
    const { diagram: diagram22 } = await import("./sankeyDiagram-4UZDY2LN.js");
    return { diagram: diagram22 };
  }, true ? __vite__mapDeps([33,2]) : void 0);
...
var loader23 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => {
    const { diagram: diagram22 } = await import("./diagram-5UYTHUR4.js");
    return { diagram: diagram22 };
  }, true ? __vite__mapDeps([34,12,14,2]) : void 0);
...
var loader24 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => {
    const { diagram: diagram22 } = await import("./diagram-ZTM2IBQH.js");
    return { diagram: diagram22 };
  }, true ? __vite__mapDeps([35,12,14,2]) : void 0);
...
var loader25 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => {
    const { diagram: diagram22 } = await import("./blockDiagram-6J76NXCF.js");
    return { diagram: diagram22 };
  }, true ? __vite__mapDeps([36,7,2,1]) : void 0);
...
var loader26 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => {
    const { diagram: diagram22 } = await import("./architectureDiagram-SUXI7LT5.js");
    return { diagram: diagram22 };
  }, true ? __vite__mapDeps([37,12,13,14,2,31]) : void 0);
...
var loader27 = /* @__PURE__ */ __name(async () => {
  const { diagram: diagram2 } = await __vitePreload(async () => {
    const { diagram: diagram22 } = await import("./diagram-VMROVX33.js");
    return { diagram: diagram22 };
  }, true ? __vite__mapDeps([38,9,12,14,2]) : void 0);
...
export {
  ...
  cleanAndMerge as G,
  getConfig as H,
  defaultConfig_default as I,
  JSON_SCHEMA as J,
  random as K,
  selectSvgElement as L,
  package_default as M,
  parseFontSize as N,
  d3arc as O,
  ordinal as P,
  d3pie as Q,
  getThemeVariables3 as R,
  linear as S,
  band as T,
  computeDimensionOfText as U,
  line$1 as V,
  hasKatex as W,
  calculateMathMLDimensions as X,
  getUrl as Y,
  ZERO_WIDTH_SPACE as Z,
  __name as _,
  getAccTitle as a,
  sum as a$,
  parseGenericTypes as a0,
  curveBasis as a1,
  generateId as a2,
  setupGraphViewbox as a3,
  isDark as a4,
  lighten as a5,
  darken as a6,
  commonDb_exports as a7,
  insertCluster as a8,
  insertNode as a9,
  min$1 as aA,
  max$1 as aB,
  interpolateHcl as aC,
  axisBottom as aD,
  timeFormat as aE,
  timeMonth as aF,
  timeSunday as aG,
  ...
  transform as a_,
  positionNode as aa,
  getLineFunctionsWithOffset as ab,
  evaluate as ac,
  createText as ad,
  getSubGraphTitleMargins as ae,
  replaceIconSubstring as af,
  decodeEntities as ag,
  getStylesFromArray as ah,
  format as ai,
  hierarchy as aj,
  treemap$1 as ak,
  styles2String as al,
  isLabelStyle as am,
  markers_default as an,
  clear2 as ao,
  clear as ap,
  clear$1 as aq,
  updateNodeBounds as ar,
  setNodeElem as as,
  insertEdge as at,
  positionEdgeLabel as au,
  insertEdgeLabel as av,
  getIconSVG as aw,
  registerIconPacks as ax,
  unknownIcon as ay,
  time as az,
  setAccTitle as b,
  zoom as b0,
  ...
  lineBreakRegex as o,
  setConfig2 as p,
  getRegisteredLayoutAlgorithm as q,
  render$1 as r,
  setAccDescription as s,
  setDiagramTitle as t,
  utils_default as u,
  getDiagramTitle as v,
  wrapLabel as w,
  load as x,
  isValidShape as y,
  getEdgeId as z
