import { p as createLucideIcon, aa as createRovingFocusGroupScope, ab as useDirection, ac as useControllableState, j as jsxRuntimeExports, ad as createContextScope, ae as Root, af as Primitive, ag as useComposedRefs, ah as Item, ai as composeEventHandlers, aj as Presence, ak as usePrevious, al as useSize, c as cn, u as useTranslate, U as User$1, b as useLoading, am as Dialog, an as DialogContent, ao as DialogHeader, ap as DialogTitle, aq as Label, I as Input, N as User_Role, ar as DialogFooter, B as Button, n, O as userServiceClient, o as observer, e as useCurrentUser, as as useDialog, V as userStore, at as Plus, S as State, au as DropdownMenu, av as DropdownMenuTrigger, aw as EllipsisVertical, ax as DropdownMenuContent, ay as DropdownMenuItem, az as Slot, aA as cva, w as workspaceStore, aB as Switch, aC as X, aD as Check, aE as WorkspaceSetting_MemoRelatedSetting, aF as workspaceSettingNamePrefix, aG as WorkspaceSetting_Key, W as UserAvatar, aH as Textarea, aI as convertFileToBase64, D as Trash, X as copy, aJ as PenLine, G as Link, a4 as Select, a5 as SelectTrigger, aK as VisibilityIcon, aL as convertVisibilityFromString, a6 as SelectValue, a7 as SelectContent, aM as Visibility, aN as convertVisibilityToString, a9 as SelectItem, y as Separator, aO as FieldMapping, K as IdentityProvider_Type, aP as OAuth2Config, h as absolutifyLink, H as identityProviderServiceClient, T as TooltipProvider, z as Tooltip, C as TooltipTrigger, F as TooltipContent, aQ as WorkspaceSetting_StorageSetting, aR as WorkspaceSetting_StorageSetting_StorageType, aS as WorkspaceSetting_StorageSetting_S3Config, aT as WorkspaceSetting_GeneralSetting_CustomProfile, aU as DialogDescription, aV as WorkspaceSetting_GeneralSetting, k as useResponsiveWidth, aW as useLocation, l as MobileHeader, aX as Library, aY as Settings2, aZ as Users } from "./index.js";
...
function CreateUserDialog({ open, onOpenChange, user: initialUser, onSuccess }) {
  ...
  const handleConfirm = async () => {
    if (isCreating && (!user.username || !user.password)) {
      n.error("Username and password cannot be empty");
      return;
    }
    try {
      ...
      if (isCreating) {
        ...
        n.success("Create user successfully");
      } else {
        const updateMask = [];
        ...
        n.success("Update user successfully");
      }
...
const MemoRelatedSettings = observer(() => {
  ...
  const updateSetting = async () => {
    if (memoRelatedSetting.reactions.length === 0) {
      n.error("Reactions must not be empty.");
      return;
    }
    try {
      ...
      n.success(t("message.update-succeed"));
    } catch (error) {
      n.error(error.details);
      console.error(error);
    }
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-2 w-full flex flex-row flex-wrap gap-1", children: [
        memoRelatedSetting.reactions.map((reactionType) => {
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { variant: "outline", className: "flex items-center gap-1 h-8", children: [
            reactionType,
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
...
function ChangeMemberPasswordDialog({ open, onOpenChange, user, onSuccess }) {
  ...
  const handleSaveBtnClick = async () => {
    ...
    if (newPassword === "" || newPasswordAgain === "") {
      n.error(t("message.fill-all"));
      return;
    }
    if (newPassword !== newPasswordAgain) {
      n.error(t("message.new-password-not-match"));
      setNewPasswordAgain("");
      return;
    }
    try {
  ...
  const handleAvatarChanged = async (e) => {
    ...
    if (files && files.length > 0) {
      ...
      try {
        ...
        console.error(error);
        n.error(`Failed to convert image to base64`);
      }
    }
  };
...
function CreateAccessTokenDialog({ open, onOpenChange, onSuccess }) {
  ...
  const handleSaveBtnClick = async () => {
    if (!state.description) {
      n.error(t("message.description-is-required"));
      return;
    }
    try {
      requestState.setLoading();
...
const AccessTokenSection = () => {
  ...
  const copyAccessToken = (accessToken) => {
    copy(accessToken);
    n.success(t("setting.access-token-section.access-token-copied-to-clipboard"));
  };
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sm:flex sm:items-center sm:justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sm:flex-auto space-y-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "flex flex-row justify-start items-center font-medium text-muted-foreground", children: t("setting.access-token-section.title") }),
...
const UserSessionsSection = () => {
  ...
  const handleRevokeSession = async (userSession) => {
    ...
    if (confirmed) {
      ...
      n.success(t("setting.user-sessions-section.session-revoked"));
    }
  };
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-6 w-full flex flex-col justify-start items-start space-y-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sm:flex sm:items-center sm:justify-between", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sm:flex-auto space-y-1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "flex flex-row justify-start items-center font-medium text-muted-foreground", children: t("setting.user-sessions-section.title") }),
...
function CreateWebhookDialog({ open, onOpenChange, webhookName, onSuccess }) {
  ...
  const handleSaveBtnClick = async () => {
    if (!state.displayName || !state.url) {
      n.error(t("message.fill-all-required-fields"));
      return;
    }
    if (!currentUser) {
      n.error("User not authenticated");
      return;
    }
    try {
      requestState.setLoading();
...
const PreferencesSection = observer(() => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full flex flex-col gap-2 pt-2 pb-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full flex flex-row justify-between items-center", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(ThemeSelect, { value: setting.theme, onValueChange: handleThemeChange })
    ] }),
  ...
  const handleConfirmBtnClick = async () => {
    try {
      if (isCreating) {
        ...
        n.success(t("setting.sso-section.sso-created", { name: basicInfo.title }));
      } else {
        ...
        n.success(t("setting.sso-section.sso-updated", { name: basicInfo.title }));
      }
    } catch (error) {
      n.error(error.details);
      console.error(error);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full flex flex-col gap-2 pt-2 pb-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full flex flex-row justify-between items-center gap-1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-row items-center gap-1", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(LearnMore, { url: "https://www.usememos.com/docs/configuration/authentication" })
      ] }),
...
const StorageSection = observer(() => {
  ...
  const allowSaveStorageSetting = reactExports.useMemo(() => {
    ...
    if (workspaceStorageSetting.storageType === WorkspaceSetting_StorageSetting_StorageType.LOCAL) {
      ...
      if (!workspaceStorageSetting.ossConfig?.accessKeyId || !workspaceStorageSetting.ossConfig?.accessKeySecret || !workspaceStorageSetting.ossConfig?.endpoint || !workspaceStorageSetting.ossConfig?.region || !workspaceStorageSetting.ossConfig?.bucket) {
        return false;
      }
    }
  ...
  const handlePartialOSSConfigChanged = async (ossConfig) => {
    const update = {
      ...workspaceStorageSetting,
      ossConfig: {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full flex flex-col gap-2 pt-2 pb-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      RadioGroup,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center space-x-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(RadioGroupItem, { value: WorkspaceSetting_StorageSetting_StorageType.ALIYUN_OSS, id: "aliyun_oss" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "aliyun_oss", children: t("setting.storage-section.type-aliyun-oss") })
          ] })
        ]
      }
    ),
    ...
    workspaceStorageSetting.storageType === WorkspaceSetting_StorageSetting_StorageType.ALIYUN_OSS && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full flex flex-row justify-between items-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground mr-1", children: t("setting.storage-section.oss-endpoint") }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
            className: "w-64",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full flex flex-row justify-between items-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground mr-1", children: t("setting.storage-section.oss-region") }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
            className: "w-64",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full flex flex-row justify-between items-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground mr-1", children: t("setting.storage-section.oss-access-key-id") }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
            className: "w-64",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full flex flex-row justify-between items-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground mr-1", children: t("setting.storage-section.oss-access-key-secret") }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
            className: "w-64",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full flex flex-row justify-between items-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground mr-1", children: t("setting.storage-section.oss-bucket") }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
            className: "w-64",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full flex flex-row justify-between items-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground mr-1", children: t("setting.storage-section.oss-use-ssl") }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Switch, { checked: workspaceStorageSetting.ossConfig?.useSsl !== false, onCheckedChange: handleOSSConfigUseSSLChanged })
      ] })
    ] }),
...
function UpdateCustomizedProfileDialog({ open, onOpenChange, onSuccess }) {
  ...
  const handleSaveButtonClick = async () => {
    ...
    try {
      ...
      console.error(error);
      n.error("Failed to update profile");
    } finally {
      setIsLoading(false);
    }
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open, onOpenChange, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "max-w-2xl", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-4", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(ThemeSelect, {})
      ] })
    ] }),
