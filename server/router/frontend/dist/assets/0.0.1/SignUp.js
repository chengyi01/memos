import { o as observer, u as useTranslate, a as useNavigateTo, b as useLoading, w as workspaceStore, j as jsxRuntimeExports, I as Input, B as Button, L as Loader, G as Link, U as User, N as User_Role, O as userServiceClient, d as authServiceClient, i as initialUserStore, n } from "./index.js";
...
const SignUp = observer(() => {
  ...
  const handleSignUpButtonClick = async () => {
    ...
    try {
      ...
      console.error(error);
      n.error(error.details || "Sign up failed");
    }
