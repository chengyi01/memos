import { o as observer, u as useTranslate, a as useNavigateTo, b as useLoading, w as workspaceStore, j as jsxRuntimeExports, I as Input, B as Button, L as Loader, d as authServiceClient, i as initialUserStore, n } from "./index.js";
...
const PasswordSignInForm = observer(() => {
  ...
  const handleSignInButtonClick = async () => {
    ...
    try {
      ...
      console.error(error);
      n.error(error.details || "Failed to sign in.");
    }
