...
const (
	...
	WorkspaceStorageSetting_ALIYUN_OSS WorkspaceStorageSetting_StorageType = 4
)
...
type WorkspaceStorageSetting struct {
	...
	OssConfig     *StorageOSSConfig `protobuf:"bytes,7,opt,name=oss_config,json=ossConfig,proto3" json:"oss_config,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *WorkspaceStorageSetting) GetOssConfig() *StorageOSSConfig {
	if x != nil {
		return x.OssConfig
	}
	return nil
...
type StorageOSSConfig struct {
	...
	UseCustomDomain bool `protobuf:"varint,7,opt,name=use_custom_domain,json=useCustomDomain,proto3" json:"use_custom_domain,omitempty"`
...
func (x *StorageOSSConfig) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*StorageOSSConfig) ProtoMessage() {}

func (x *StorageOSSConfig) ProtoReflect() protoreflect.Message {
	mi := &file_store_workspace_setting_proto_msgTypes[6]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use StorageOSSConfig.ProtoReflect.Descriptor instead.
func (*StorageOSSConfig) Descriptor() ([]byte, []int) {
	return file_store_workspace_setting_proto_rawDescGZIP(), []int{6}
}

func (x *StorageOSSConfig) GetEndpoint() string {
	if x != nil {
		return x.Endpoint
	}
	return ""
...
func (x *StorageOSSConfig) GetRegion() string {
	if x != nil {
		return x.Region
	}
	return ""
...
func (x *StorageOSSConfig) GetAccessKeyId() string {
	if x != nil {
		return x.AccessKeyId
	}
	return ""
...
func (x *StorageOSSConfig) GetAccessKeySecret() string {
	if x != nil {
		return x.AccessKeySecret
	}
	return ""
...
func (x *StorageOSSConfig) GetBucket() string {
	if x != nil {
		return x.Bucket
	}
	return ""
...
func (x *StorageOSSConfig) GetUseSsl() bool {
	if x != nil {
		return x.UseSsl
	}
	return false
...
func (x *StorageOSSConfig) GetUseCustomDomain() bool {
	if x != nil {
		return x.UseCustomDomain
	}
	return false
}

func (x *StorageOSSConfig) GetCustomDomain() string {
	if x != nil {
...
const file_store_workspace_setting_proto_rawDesc = "" +
	...
	"\x06locale\x18\x04 \x01(\tR\x06locale\"\xa3\x03\n" +
	...
	"\n" +
	"oss_config\x18\a \x01(\v2\x1d.memos.store.StorageOSSConfigR\tossConfig\"\\\n" +
	...
	"\x0euse_path_style\x18\x06 \x01(\bR\fusePathStyle\"\x98\x02\n" +
	"\x10StorageOSSConfig\x12\x1a\n" +
	...
	"\x11use_custom_domain\x18\a \x01(\bR\x0fuseCustomDomain\x12#\n" +
	"\rcustom_domain\x18\b \x01(\tR\fcustomDomain\"\xe1\x03\n" +
