...
const (
	...
	// Attachment is stored in Aliyun OSS.
	AttachmentStorageType_ALIYUN_OSS AttachmentStorageType = 4
)
...
func (x *AttachmentPayload) GetOssObject() *AttachmentPayload_OSSObject {
	if x != nil {
		if x, ok := x.Payload.(*AttachmentPayload_OssObject); ok {
			return x.OssObject
		}
	}
	return nil
...
type AttachmentPayload_OssObject struct {
	OssObject *AttachmentPayload_OSSObject `protobuf:"bytes,2,opt,name=oss_object,json=ossObject,proto3,oneof"`
}

func (*AttachmentPayload_S3Object_) isAttachmentPayload_Payload() {}

func (*AttachmentPayload_OssObject) isAttachmentPayload_Payload() {}
...
type AttachmentPayload_OSSObject struct {
	state     protoimpl.MessageState `protogen:"open.v1"`
	OssConfig *StorageOSSConfig      `protobuf:"bytes,1,opt,name=oss_config,json=ossConfig,proto3" json:"oss_config,omitempty"`
	// key is the OSS object key.
	Key string `protobuf:"bytes,2,opt,name=key,proto3" json:"key,omitempty"`
	// last_presigned_time is the last time the object was presigned.
	// This is used to determine if the presigned URL is still valid.
	LastPresignedTime *timestamppb.Timestamp `protobuf:"bytes,3,opt,name=last_presigned_time,json=lastPresignedTime,proto3" json:"last_presigned_time,omitempty"`
...
func (x *AttachmentPayload_OSSObject) Reset() {
	*x = AttachmentPayload_OSSObject{}
	mi := &file_store_attachment_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *AttachmentPayload_OSSObject) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AttachmentPayload_OSSObject) ProtoMessage() {}

func (x *AttachmentPayload_OSSObject) ProtoReflect() protoreflect.Message {
	mi := &file_store_attachment_proto_msgTypes[2]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AttachmentPayload_OSSObject.ProtoReflect.Descriptor instead.
func (*AttachmentPayload_OSSObject) Descriptor() ([]byte, []int) {
	return file_store_attachment_proto_rawDescGZIP(), []int{0, 1}
}

func (x *AttachmentPayload_OSSObject) GetOssConfig() *StorageOSSConfig {
	if x != nil {
		return x.OssConfig
	}
	return nil
...
func (x *AttachmentPayload_OSSObject) GetKey() string {
	if x != nil {
		return x.Key
	}
	return ""
...
func (x *AttachmentPayload_OSSObject) GetLastPresignedTime() *timestamppb.Timestamp {
	if x != nil {
		return x.LastPresignedTime
	}
	return nil
...
const file_store_attachment_proto_rawDesc = "" +
	"\n" +
	"\x16store/attachment.proto\x12\vmemos.store\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1dstore/workspace_setting.proto\"\x81\x04\n" +
	"\x11AttachmentPayload\x12F\n" +
	"\ts3_object\x18\x01 \x01(\v2'.memos.store.AttachmentPayload.S3ObjectH\x00R\bs3Object\x12I\n" +
	"\n" +
	"oss_object\x18\x02 \x01(\v2(.memos.store.AttachmentPayload.OSSObjectH\x00R\tossObject\x1a\xa3\x01\n" +
	"\bS3Object\x129\n" +
	"\ts3_config\x18\x01 \x01(\v2\x1c.memos.store.StorageS3ConfigR\bs3Config\x12\x10\n" +
	"\x03key\x18\x02 \x01(\tR\x03key\x12J\n" +
	"\x13last_presigned_time\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\x11lastPresignedTime\x1a\xa7\x01\n" +
	"\tOSSObject\x12<\n" +
	"\n" +
	"oss_config\x18\x01 \x01(\v2\x1d.memos.store.StorageOSSConfigR\tossConfig\x12\x10\n" +
	"\x03key\x18\x02 \x01(\tR\x03key\x12J\n" +
...
var file_store_attachment_proto_goTypes = []any{
	...
	(*AttachmentPayload_OSSObject)(nil), // 3: memos.store.AttachmentPayload.OSSObject
	(*StorageS3Config)(nil),             // 4: memos.store.StorageS3Config
	(*timestamppb.Timestamp)(nil),       // 5: google.protobuf.Timestamp
	(*StorageOSSConfig)(nil),            // 6: memos.store.StorageOSSConfig
}
var file_store_attachment_proto_depIdxs = []int32{
	...
	3, // 1: memos.store.AttachmentPayload.oss_object:type_name -> memos.store.AttachmentPayload.OSSObject
	4, // 2: memos.store.AttachmentPayload.S3Object.s3_config:type_name -> memos.store.StorageS3Config
	5, // 3: memos.store.AttachmentPayload.S3Object.last_presigned_time:type_name -> google.protobuf.Timestamp
	6, // 4: memos.store.AttachmentPayload.OSSObject.oss_config:type_name -> memos.store.StorageOSSConfig
	5, // 5: memos.store.AttachmentPayload.OSSObject.last_presigned_time:type_name -> google.protobuf.Timestamp
...
func file_store_attachment_proto_init() {
	...
	file_store_attachment_proto_msgTypes[0].OneofWrappers = []any{
		...
		(*AttachmentPayload_OssObject)(nil),
	}
	type x struct{}
